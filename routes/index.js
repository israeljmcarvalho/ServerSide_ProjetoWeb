...
//  res.render('testimonials', {title: 'Relação de Testemunhos', pig: ltestimonials});  //testimonials refere-se ao arquivo testimonials.ejs que é o arquivo onde as informações serão enviadas | ltestimonials é o que será rederizado (variável criada acima)
